...
public class CustomerFrame extends JFrame {
	...
	private void initialize() {
		...
		logoIMG = new ImageIcon("src\\images\\Logo.png");
		backgroundIMG = new ImageIcon("src\\images\\WALLPAPER.PNG");
		search_inactiveIMG = new ImageIcon("src\\images\\searchButtonInactive.PNG");
		search_activeIMG = new ImageIcon("src\\images\\searchButtonActive.PNG");
		profile_inactiveIMG = new ImageIcon("src\\images\\profileButtonInactive.png");
		profile_activeIMG = new ImageIcon("src\\images\\profileButtonActive.png");
	...
	private void events() {
		...
		this.addComponentListener(new ComponentAdapter() {
		    public void componentResized(ComponentEvent componentEvent) {
				background.setIcon(resize(backgroundIMG, CustomerFrame.this.getWidth(),CustomerFrame.this.getHeight()));
		    }
		});
